import xincludes from "./xincludes"
...
describe(`function xincludes(needle)`, () => {
    context(`xincludes is composed with other transducer`, () => {
        ...
        context(`xs is type of Array`, () => {
            context(`xs is empty`, () => {
                it(`should return false`, () => {
                    const xs = []
                    expect(seq(compose(pipeline, xincludes(10)), xs))
                        .toEqual(false)
                })
            })
            ...
            context(`xs is not empty`, () => {
                it(`should return false`, () => {
                    ...
                    expect(seq(compose(pipeline, xincludes(13)), xs))
                        .toEqual(false)
                })
